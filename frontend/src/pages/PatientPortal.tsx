...
import { doctorById, formatInr, patientById, reports } from '../data/mockData';

export function PatientPortal() {
  const patient = patientById('PAT-2026-0142');
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_330px]">
        <section className="grid gap-5">
          <div className="grid gap-4 sm:grid-cols-3">
            <StatCard detail="2 verified" icon={<FileText size={20} />} label="Reports" value="6" />
            <StatCard detail="Next: 29 Aug" icon={<CalendarDays size={20} />} label="Upcoming Bookings" value="1" />
            <StatCard detail="Across 2026" icon={<IndianRupee size={20} />} label="Total Spend" value={formatInr(18450)} />
          </div>
